    ...
    <>
      ...
      <main className="about" style={{ maxWidth: "1100px", margin: "100px auto 60px", padding: "0 20px", display: "flex", flexDirection: "column", gap: "48px" }}>
        <section className="about-hero" style={{ display: "grid", gridTemplateColumns: visibleCount === 1 ? "1fr" : "1.2fr 1fr", gap: "36px", alignItems: "center" }}>
          ...
          <div className="about-right" style={{ position: "relative", width: "100%", borderRadius: "20px", boxShadow: "0 8px 32px rgba(0,0,0,0.5)", overflow: "hidden", display: "flex" }}>
            <img src={coverPhoto || "/foto1.jpeg"} alt="Forza Gaming Espor Salonu" style={{ width: "100%", height: "auto", objectFit: "cover", display: "block", aspectRatio: "16/9" }} />
          </div>
        </section>
